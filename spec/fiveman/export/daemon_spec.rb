...
describe Fiveman::Export::Daemon, :fakefs do
  ...
  context "with alternate templates from home dir" do
    ...
    before do
      FileUtils.mkdir_p File.expand_path("~/.fiveman/templates/daemon")
      File.open(File.expand_path("~/.fiveman/templates/daemon/master.conf.erb"), "w") do |file|
