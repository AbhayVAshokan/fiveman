...
describe Fiveman::Export::Upstart, :fakefs do
  ...
  context "with alternate templates from home dir" do
    ...
    before do
      FileUtils.mkdir_p File.expand_path("~/.fiveman/templates/upstart")
      File.open(File.expand_path("~/.fiveman/templates/upstart/master.conf.erb"), "w") do |file|
