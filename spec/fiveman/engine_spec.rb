...
class Fiveman::Engine::Tester < Fiveman::Engine
  attr_reader :buffer
...
describe "Fiveman::Engine", :fakefs do
  subject do
    write_procfile "Procfile"
    Fiveman::Engine::Tester.new.load_procfile("Procfile")
  end
  ...
  describe "directories" do
    it "has the directory default relative to the Procfile" do
      ...
      engine = Fiveman::Engine.new.load_procfile("/some/app/Procfile")
